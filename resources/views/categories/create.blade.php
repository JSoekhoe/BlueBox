                ...
                <div class="p-4 md:p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('categories.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="Category" id="Category" class="mt-1 p-2 block w-full border rounded-md dark:bg-gray-700 dark:text-gray-300" required autofocus />
                        </div>
                        <div class="mb-4">
                            <label for="Description" class="block text-sm font-medium text-gray-700 dark:text-gray-400">Description</label>
                            <textarea name="Description" id="Description" rows="4" class="mt-1 p-2 block w-full border rounded-md dark:bg-gray-700 dark:text-gray-300" required></textarea>
                        </div>
