            ...
            <div class="p-4 md:p-6 text-gray-900 dark:text-gray-100">
                <form action="{{ route('partners.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="Partner_name" id="partner_name" class="form-input mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" placeholder="Enter Partner Name" required>
                    </div>
                    <div class="mb-4">
