                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            @foreach($contracts as $contract)
                                <tr>
                                    ...
                                    <td class="px-4 py-2 md:px-6 md:py-3 text-left text-xs md:text-sm leading-4 font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                                        <a href="{{ route('contracts.edit', $contract) }}" class="text-blue-600 dark:text-blue-400 hover:text-blue-900 dark:hover:text-blue-600">Edit</a>
                                        ...
                                        <a href="{{ route('contracts.pdf', $contract) }}" class="text-green-600 dark:text-green-400 hover:text-green-900 dark:hover:text-green-600">Convert to PDF</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
